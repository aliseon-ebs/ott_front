...
public class VoyageResult {
    ...
    @SerializedName("list")
    @Expose
    public ArrayList<List> voyageresult_list = new ArrayList<>();
    ...
    public ArrayList<List> getList() {return voyageresult_list;}

    public void setList(ArrayList<List> voyageresult_list) {
        this.voyageresult_list = voyageresult_list;
    }
