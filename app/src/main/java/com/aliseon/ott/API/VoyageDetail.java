...
public class VoyageDetail {
    ...
    public class List {
        ...
        public class Detail {
            ...
            @SerializedName("subscribeto_cnt")
            @Expose
            private Integer subscribetoCnt;
            @SerializedName("status")
            @Expose
            ...
            public Integer getSubscribetoCnt() { return subscribetoCnt; }

            public void setSubscribetoCnt(Integer subscribetoCnt) { this.subscribetoCnt = subscribetoCnt; }
        ...
        public class Related {
            ...
            @SerializedName("thumbnail")
            @Expose
            private ArrayList<String> thumbnail = null;
            ...
            public ArrayList<String> getThumbnail() { return thumbnail; }

            public void setThumbnail(ArrayList<String> thumbnail) { this.thumbnail = thumbnail; }
