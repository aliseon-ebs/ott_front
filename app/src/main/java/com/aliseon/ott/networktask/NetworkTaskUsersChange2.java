...
import static com.aliseon.ott.activity.LoadingActivity.setChangeAccount2;
import static com.aliseon.ott.activity.SettingUserManagementActivity.settingactivityuseraccountmanagementaccountchange2handler;
import static com.aliseon.ott.Variable.userinfo;
import static com.aliseon.ott.Variable.userinfouid;

public class NetworkTaskUsersChange2 extends AsyncTask<Void, Void, String> {
    ...
    public NetworkTaskUsersChange2(String url, ContentValues values) {
