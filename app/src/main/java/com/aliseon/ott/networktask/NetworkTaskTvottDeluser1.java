...
import com.aliseon.ott.request_http_url_connection.RequestHttpURLConnectionTvottDeluser1;
...
import static com.aliseon.ott.activity.LoadingActivity.CheckUsedUserDisconnect1;
import static com.aliseon.ott.Variable.userinfo;
import static com.aliseon.ott.Variable.userinfouid;

public class NetworkTaskTvottDeluser1 extends AsyncTask<Void, Void, String> {
    ...
    private static String TAG3 = "가져온 데이터 ArrayList에 넣기";
        ...
        public NetworkTaskTvottDeluser1(String url, ContentValues values) {
        ...
        protected String doInBackground(Void... params) {
            ...
            RequestHttpURLConnectionTvottDeluser1 requestHttpURLConnectiontvottdeluser1 = new RequestHttpURLConnectionTvottDeluser1();
            result = requestHttpURLConnectiontvottdeluser1.request(url, values); // 해당 URL로 부터 결과물을 얻어온다.
        ...
        protected void onPostExecute(String s) {
            ...
            if(LoadingActivity.pref.getBoolean("selectaccount", true) == false){
                ...
                Disconnect1mHandler.sendEmptyMessage(1000);
            }
