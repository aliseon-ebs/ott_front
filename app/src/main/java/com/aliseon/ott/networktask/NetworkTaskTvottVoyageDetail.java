...
import static com.aliseon.ott.Variable.voyage_detail_category_en;
import static com.aliseon.ott.Variable.voyage_detail_category_id;
import static com.aliseon.ott.Variable.voyage_detail_category_kr;
import static com.aliseon.ott.Variable.voyage_detail_comment_count;
import static com.aliseon.ott.Variable.voyage_detail_contents;
import static com.aliseon.ott.Variable.voyage_detail_contents_id;
import static com.aliseon.ott.Variable.voyage_detail_contents_type;
import static com.aliseon.ott.Variable.voyage_detail_create_at;
import static com.aliseon.ott.Variable.voyage_detail_description;
import static com.aliseon.ott.Variable.voyage_detail_id;
import static com.aliseon.ott.Variable.voyage_detail_item_brand;
...
import static com.aliseon.ott.Variable.voyage_detail_item_previous_price;
...
import static com.aliseon.ott.Variable.voyage_detail_items;
import static com.aliseon.ott.Variable.voyage_detail_like_count;
import static com.aliseon.ott.Variable.voyage_detail_nickname;
import static com.aliseon.ott.Variable.voyage_detail_photo;
import static com.aliseon.ott.Variable.voyage_detail_product_id;
import static com.aliseon.ott.Variable.voyage_detail_status;
import static com.aliseon.ott.Variable.voyage_detail_update_at;
import static com.aliseon.ott.Variable.voyage_detail_user_id;
import static com.aliseon.ott.Variable.voyage_detail_view_count;
import static com.aliseon.ott.Variable.voyage_related_comment_count;
import static com.aliseon.ott.Variable.voyage_related_contents;
import static com.aliseon.ott.Variable.voyage_related_create_at;
...
import static com.aliseon.ott.Variable.voyage_related_like_count;
import static com.aliseon.ott.Variable.voyage_related_status;
import static com.aliseon.ott.Variable.voyage_related_update_at;
import static com.aliseon.ott.Variable.voyage_related_user_id;
import static com.aliseon.ott.Variable.voyage_related_view_count;
        ...
        if (s != null) {
            try {
                ...
                for (int i = 0; i < ja_voyagedetail.length(); i++) {
                    ...
                    String category_kr = jo_voyagedetaildata.getString("category_kr");
                    String name = jo_voyagedetaildata.getString("name");
