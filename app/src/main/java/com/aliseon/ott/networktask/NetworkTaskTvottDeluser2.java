...
import com.aliseon.ott.request_http_url_connection.RequestHttpURLConnectionTvottDeluser2;
...
import static com.aliseon.ott.activity.LoadingActivity.CheckUsedUserDisconnect2;
import static com.aliseon.ott.Variable.userinfo;
import static com.aliseon.ott.Variable.userinfouid;

public class NetworkTaskTvottDeluser2 extends AsyncTask<Void, Void, String> {
    ...
    public NetworkTaskTvottDeluser2(String url, ContentValues values) {
    ...
    protected String doInBackground(Void... params) {
        ...
        RequestHttpURLConnectionTvottDeluser2 requestHttpURLConnectiontvottdeluser2 = new RequestHttpURLConnectionTvottDeluser2();
        result = requestHttpURLConnectiontvottdeluser2.request(url, values); // 해당 URL로 부터 결과물을 얻어온다.
...
//        CheckUsedUserDisconnect2();
        ...
        if(LoadingActivity.pref.getBoolean("selectaccount", true) == false){
            Disconnect2mHandler.sendEmptyMessage(600);
        } else {
            Disconnect2mHandler.sendEmptyMessage(1000);
        }
