...
import static com.aliseon.ott.activity.LoadingActivity.setDataLanguageSetting;
...
public class NetworkTaskUsersSettings extends AsyncTask<Void, Void, String> {
    ...
    public NetworkTaskUsersSettings(String url, ContentValues values) {
