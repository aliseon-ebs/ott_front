...
//
//import static com.aliseon.ott.activity.LoadingActivity.LoadingmHandler;
//import static com.aliseon.ott.Aliseon.userinfo;
//import static com.aliseon.ott.Aliseon.userinfouid;
//
//public class NetworkTaskTvottUsers extends AsyncTask<Void, Void, String> {
//
...
//
//    public NetworkTaskTvottUsers(String url, ContentValues values) {
//
//        this.url = url;
//        this.values = values;
//    }
