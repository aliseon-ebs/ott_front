...
public class NetworkTaskUsersSettingsDefault extends AsyncTask<Void, Void, String> {
    ...
    public NetworkTaskUsersSettingsDefault(String url, ContentValues values) {
...
//        setDataUserinfo();
//        NetworkTaskTvottUsers networkTasktvottusers = new NetworkTaskTvottUsers(url6, null);
