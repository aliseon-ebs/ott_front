...
import static com.aliseon.ott.activity.LoadingActivity.setChangeAccount3;
import static com.aliseon.ott.activity.SettingUserManagementActivity.settingactivityuseraccountmanagementaccountchange3handler;
import static com.aliseon.ott.Variable.userinfo;
import static com.aliseon.ott.Variable.userinfouid;

public class NetworkTaskUsersChange3 extends AsyncTask<Void, Void, String> {
    ...
    public NetworkTaskUsersChange3(String url, ContentValues values) {
