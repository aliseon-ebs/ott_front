...
import static com.aliseon.ott.activity.EmptyChangeAccount2Activity.EmptyAccountChange2mHandler;
...
public class NetworkTaskUserPhoneCheckEmptyAccountChange2 extends AsyncTask<Void, Void, String> {
    ...
    public NetworkTaskUserPhoneCheckEmptyAccountChange2 (String url, ContentValues values) {
    ...
    protected void onPostExecute(String s) {
        ...
        if(infocheck_id != myuid){
            ...
            NetworkTaskUsersEmptyChange2 networktaskusersemptychange2 = new NetworkTaskUsersEmptyChange2(api_tvott_users, null);
            networktaskusersemptychange2.execute();
        }
        infocheck_id = -1;
        myuid = -2;
