...
public class RequestHttpURLConnectionTvottAdduser {
    ...
    private static String TAG = "JSON status 및 메세지 tvottadduser";
...
//        URL 뒤에 붙여서 보낼 파라미터.
        StringBuffer sbParams = new StringBuffer("access_token=" + access_token + "&" + "user_id=" + infocheck_id);
         ...
         * */
        try{
            URL url7 = new URL(_url);
            urlConn = (HttpURLConnection) url7.openConnection();
