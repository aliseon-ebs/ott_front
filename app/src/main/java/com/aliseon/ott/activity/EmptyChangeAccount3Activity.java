...
public class EmptyChangeAccount3Activity extends AppCompatActivity {
    ...
    public static MyHandler EmptyAccountChange3mHandler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EmptyAccountChange3mHandler = new MyHandler();
        ...
        //UI생성
        spinner1 = (Spinner) findViewById(R.id.changespinner3);
        ...
        Button button = (Button) findViewById(R.id.changecancel3);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent intent = new Intent(EmptyChangeAccount3Activity.this, EmptySelectAccount3Activity.class);
...
//                finish();
        ...
        Button button2 = (Button) findViewById(R.id.changechange3);
    ...
    public class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1000) {
                Intent intent = new Intent(EmptyChangeAccount3Activity.this, HomeActivity.class);
