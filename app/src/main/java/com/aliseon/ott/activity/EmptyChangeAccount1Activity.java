...
import com.aliseon.ott.networktask.NetworkTaskUserPhoneCheckEmptyAccountChange1;
...
public class EmptyChangeAccount1Activity extends AppCompatActivity {

    public static MyHandler EmptyAccountChange1mHandler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.change_account1);
        ...
        EmptyAccountChange1mHandler = new MyHandler();
        ...
        //UI생성
        spinner1 = (Spinner) findViewById(R.id.changespinner1);
        ...
        Button button = (Button) findViewById(R.id.changecancel1);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent intent = new Intent(EmptyChangeAccount1Activity.this, EmptySelectAccount1Activity.class);
...
//                finish();
        ...
        Button button2 = (Button) findViewById(R.id.changechange1);
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EmptyAccountChange1mHandler.post(new Runnable() {
                    @Override
                    public void run() {
                        EditText editText = (EditText) findViewById(R.id.change_number1);
                        String editTextnumber = editText.getText().toString();
                        phone_number = editTextnumber;

                        myuid = userinfouid.get(0);

                        NetworkTaskUserPhoneCheckEmptyAccountChange1 networkTaskuserphonecheckemptyaccountchange1 = new NetworkTaskUserPhoneCheckEmptyAccountChange1 (api_usersetting_user_phone, null);
                        networkTaskuserphonecheckemptyaccountchange1.execute();
                    }
                });
            }
        });
...
//                editor.putString("language", userinfo.get(3));
//                editor.putBoolean("selectaccount", true);
//                editor.commit();
                Intent intent = new Intent(EmptyChangeAccount1Activity.this, HomeActivity.class);
