...
public class EmptySelectAccount2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_account_selectuser2);
...
//        Layout2.addView(Layout2_4);
        ...
        Glide.with(this).load(userinfo.get(8)).into(Profile);
...
//        Layout1.addView(Layout3);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(EmptySelectAccount2Activity.this, EmptyUserSelectActivity.class);
...
//                finish();
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EmptySelectAccount2Activity.this, EmptyChangeAccount2Activity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
//                finish();
            }
