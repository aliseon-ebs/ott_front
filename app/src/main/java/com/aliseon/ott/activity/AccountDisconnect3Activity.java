...
import com.aliseon.ott.networktask.NetworkTaskUserPhoneCheckDisconnect3;
            ...
            public void onClick(View v) {
                Disconnect3mHandler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        NetworkTaskUserPhoneCheckDisconnect3 networkTaskuserphonedisconnect3= new NetworkTaskUserPhoneCheckDisconnect3(api_usersetting_user_phone, null);
                        networkTaskuserphonedisconnect3.execute();
                    }
                });
            }
        });
