...
public class EmptySelectAccount3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_account_selectuser3);
        ...
        AliseonAPI = retrofit.create(com.aliseon.ott.AliseonAPI.class);
        ...
        Profile = new CircleImageView(this);
...
//        Layout3_1_2.addView(name[0]);
        ...
        Glide.with(this).load(userinfo.get(14)).into(Profile);
        name[1].setText(userinfo.get(12));
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(EmptySelectAccount3Activity.this, EmptyUserSelectActivity.class);
...
//                finish();
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EmptySelectAccount3Activity.this, EmptyChangeAccount3Activity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
//                finish();
            }
